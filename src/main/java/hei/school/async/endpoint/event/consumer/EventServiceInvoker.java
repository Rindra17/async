package hei.school.async.endpoint.event.consumer;

import hei.school.async.PojaGenerated;
import hei.school.async.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.school.async.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.school.async.service.event."
