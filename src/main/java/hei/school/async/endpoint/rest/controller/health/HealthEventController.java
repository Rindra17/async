package hei.school.async.endpoint.rest.controller.health;

import static hei.school.async.endpoint.rest.controller.health.PingController.KO;
import static hei.school.async.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import hei.school.async.PojaGenerated;
import hei.school.async.endpoint.event.EventProducer;
import hei.school.async.endpoint.event.model.DurablyFallibleUuidCreated1;
import hei.school.async.endpoint.event.model.UuidCreated;
import hei.school.async.repository.DummyUuidRepository;
import hei.school.async.repository.model.DummyUuid;
