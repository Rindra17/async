package hei.school.async.handler;

import static hei.school.async.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.async.PojaApplication;
import hei.school.async.PojaGenerated;
import hei.school.async.endpoint.EndpointConf;
import hei.school.async.endpoint.event.EventConf;
import hei.school.async.endpoint.event.consumer.EventConsumer;
import hei.school.async.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.async.endpoint.event.consumer.model.ConsumableEventTyper;
